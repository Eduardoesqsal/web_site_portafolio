...
export function createCvPdf() {
  const content = [
    ...
    text(10, 42, 615, "Desarrollador Full Stack especializado en aplicaciones geoespaciales,", 0.3),
    text(10, 42, 599, "inteligencia artificial, vision por computadora y automatizacion.", 0.3),
    text(10, 42, 583, "Construyo productos claros, rapidos y preparados para crecer.", 0.3),
    ...
    text(11, 42, 437, "Geospatial Software Developer", 0.12),
    text(9, 430, 437, "2022 - 2024", 0.42),
    text(9, 42, 421, "Proyectos GIS y agricultura", 0.35),
    text(9, 54, 399, "Visores, PostGIS, ortomosaicos y automatizacion geoespacial.", 0.4),
    ...
    text(10, 42, 232, "GIS e inteligencia artificial", 0.12),
    ...
    text(9, 42, 92, "GeoAI | Computer Vision | Infraestructura de datos | AI Agents | Automatizacion", 0.35),
