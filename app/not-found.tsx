...
export default function NotFound() {
  return (
    <main className="grid min-h-screen place-items-center bg-[#f4fafb] px-5 text-center">
      <div>
        <p className="text-xs font-bold uppercase tracking-[.2em] text-[#0e8e9a]">Error 404</p>
